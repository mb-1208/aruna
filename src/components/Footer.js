      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-16 md:gap-8 mb-16">
        ...
        <div className="flex-1 md:pr-12 mb-12 md:mb-0">
          ...
          <div className="pl-2 flex gap-4 items-center mb-8">
            <a href={socialLinks.whatsapp || "#"} className="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
              <IconBrandWhatsapp size={20} stroke={1.5} />
            </a>
            <a href={socialLinks.instagram || "#"} className="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
              <IconBrandInstagram size={20} stroke={1.5} />
            </a>
            <a href={socialLinks.tiktok || "#"} className="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
              <IconBrandTiktok size={20} stroke={1.5} />
            </a>
            <a href={socialLinks.facebook || "#"} className="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
          ...
          {status === "success" ? (
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              <input
                ...
                className="flex-1 bg-transparent border-b border-gray-300 px-0 py-2 text-base text-white placeholder-gray-500 focus:outline-none focus:border-white transition-colors disabled:opacity-50"
              />
