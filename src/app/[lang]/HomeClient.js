...
export default function HomeClient({ content }) {
  ...
  return (
    <div className="relative h-screen w-full flex flex-col md:flex-row overflow-hidden font-sans">
      ...
      >
        {logoImage ? (
          <Image src={logoImage} alt="Aruna Logo" width={300} height={128} className="h-32 2xl:h-48 w-auto drop-shadow-md" unoptimized priority />
        ) : (
          <Image src={logo} alt="Aruna Logo" className="h-32 2xl:h-48 w-auto drop-shadow-md" priority />
        )}
      </motion.div>
